...
const classNamesTabActive = 'inline-flex items-center justify-center p-4 text-blue-600 border-b-2 border-blue-600 rounded-t-lg hover:bg-gray-200 active dark:text-blue-500 dark:border-blue-500 group';
...
export default function TabItem({ tabName, tabActive, setTabActive, icon, ...props }) {
	let isActive = tabActive === tabName;
